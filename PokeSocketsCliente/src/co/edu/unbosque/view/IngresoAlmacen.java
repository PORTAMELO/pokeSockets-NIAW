...
public class IngresoAlmacen extends JFrame {
	...
	public void inicializarComponentes() {
		label = new JLabel();
		add(label);
		imagen = new ImageIcon(getClass().getResource("/co/edu/unbosque/util/ingresoalmacen.jpeg"));
		...
		ingresar.setActionCommand("ingresarAl");
		ingresar.setBounds(135, 502, 152, 50);
